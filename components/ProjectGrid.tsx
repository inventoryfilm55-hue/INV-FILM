          ...
          return (
            ...
            >
              <div className={`relative overflow-hidden bg-neutral-900 transition-all duration-700 w-full ${isVertical ? 'aspect-[9/16]' : 'aspect-video'}`}>
                ...
                {/* Responsive High-End Overlay */}
                <div className="absolute inset-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center justify-center p-4 md:p-12 text-center backdrop-blur-[10px]">
                  <div className="w-full max-w-full flex flex-col items-center translate-y-6 group-hover:translate-y-0 transition-all duration-700">
                    ...
                    {/* 
                        ...
                        - Adjusts scale based on screen width
                        - Hyphens and word break for safety
                    */}
                    <h3 className="text-white font-logo font-black text-[clamp(1.5rem,9vw,5.5rem)] md:text-[clamp(2rem,4vw,6rem)] leading-[0.8] tracking-tighter uppercase mb-6 break-words overflow-hidden w-full hyphens-auto">
                      {project.title}
                    </h3>
                    ...
                    <p className="text-white/40 text-[max(8px,0.6vw)] font-bold tracking-[0.3em] uppercase opacity-0 group-hover:opacity-100 transition-opacity delay-300">
